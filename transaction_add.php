<?php
    ...
    if(isset($_POST['submit'])){
        ...
        // Create insert query
        $query = "INSERT INTO transaction(datelog, employee_id, office_id, action, remarks, documentcode)
                  VALUES(sysdate(),'$employee_id', '$office_id', '$action', '$remarks', '$documentcode')";
                                        ...
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="employee_id">
                                                    <?php
                                                    $categories = mysqli_query($conn, 'SELECT id, concat(lastname, ", ", firstname) as name,  office_id, address FROM employee');
                                                    while($c = mysqli_fetch_array($categories)) {
                                                        ?>
                                                        <option value="<?php echo $c['id'];?>"><?php echo $c['name']?></option>
                                                    <?php } ?>
